            ...
            {activeProgram ? (
                <div className="flex-1 flex flex-col">
                    ...
                    <button
                        ...
                        className="w-full bg-slate-800/60 hover:bg-slate-700/60 text-white py-2.5 px-4 rounded-lg font-medium transition-all duration-200 border border-white/5 hover:border-lime-400/30"
                    >
                        View Details →
                    </button>
                </div>
