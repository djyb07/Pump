...
const navLinks = [
    ...
    { path: '/exercises', label: 'Exercises', emoji: '📚' },
        ...
        <>
            ...
            >
                <div className="flex items-center justify-between px-4 h-14">
                    ...
                    <button
                        onClick={onLogout}
                        className="px-3 py-1.5 rounded-lg bg-slate-800/60 hover:bg-slate-700/60 border border-white/5 text-slate-300 text-sm font-medium"
                    >
                        🚪
                    </button>
                </div>
