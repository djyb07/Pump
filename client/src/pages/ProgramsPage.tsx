            ...
            <UnifiedPageHeader
                ...
                rightContent={
                    <button
                        ...
                        className="px-4 py-2 bg-lime-400 hover:bg-lime-500 text-slate-950 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 shadow-lg text-sm">
                        + New Program
                    </button>
                }
            />
